 ...
 * </p>
 * <ul>
 *   <li>{@link Epc.impl.EventImpl#isStart <em>Start</em>}</li>
 *   <li>{@link Epc.impl.EventImpl#isEnd <em>End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends ControlFlowNodeImpl implements Event {
	/**
	...
	public void setStart(boolean newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EpcPackage.EVENT__START, oldStart, start));
	}
	...
	public void setEnd(boolean newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EpcPackage.EVENT__END, oldEnd, end));
	}
